...
PadKontrol.prototype.open = function (inport, outport) {
  ...
  this.__sendInitialization();

  // Ugly hack to fix crashing PadKontrol pad
  timers.setInterval(this.__sendInitialization, 5 * 60 * 1000);
}

PadKontrol.prototype.__sendInitialization = function() {
